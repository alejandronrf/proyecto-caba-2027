      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-16 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
            ...
            {/* 1st item */}
            <div className="relative flex flex-col items-center bg-purple-100 border-2 border-purple-500 p-6 rounded-lg" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
            ...
            <div className="relative flex flex-col items-center bg-purple-100 border-2 border-purple-500 p-6 rounded-lg" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2 text-gray-400">Ciudad <span className="h4 mb-2 text-purple-600">Sin Barreras</span>:</h4>
